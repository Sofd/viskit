...
import de.sofd.viskit.test.image3D.*;
...
public class Dicom3DView  {
    ...
    //        skinStripper.SetInput(skinNormals.GetOutput());
        ...
        /*panel.GetRenderer().AddActor(skin);
        panel.GetRenderer().AddActor(bone);
        panel.GetRenderer().SetActiveCamera(aCamera);
