...
public class SliceView extends GLCanvas implements GLEventListener
{
    ...
    public void reshape(GLAutoDrawable drawable, int x, int y, int width, int height) {
        ...
        try {
            ...
            {
//                viewports.add( new SliceViewport( quadSizeX, 0, quadSizeX, quadSizeY, ImagePlaneType.PLANE_SAGITTAL, volumeObject ) );
//                viewports.add( new SliceViewport( 0, quadSizeY, quadSizeX, quadSizeY, ImagePlaneType.PLANE_TRANSVERSE, volumeObject ) );
//                viewports.add( new SliceViewport( 0, 0, quadSizeX, quadSizeY, ImagePlaneType.PLANE_CORONAL, volumeObject ) );
//                
