...
public class TransferIntegrationFrameBuffer extends FrameBuffer
{
    ...
    public void setTransferFunction(    GL2 gl,
                                        FloatBuffer transferFunction,
                                        int transferTexId ) throws Exception
    {
        this.transferFunction = transferFunction;
        this.transferTexId = transferTexId;
        
        this.resize( gl, internalFormat, format, new Size( transferFunction.capacity() / 4,
                transferFunction.capacity() / 4 ) );
    }
}