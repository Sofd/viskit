...
public class GLUtil
{
                                            ...
                                            VolumeObject volumeObject ) throws Exception
    {
        ...
        for ( DicomObject dicomObject : dicomList )
        {
            ...
            glu.gluBuild2DMipmaps( GL_TEXTURE_2D, GL_ALPHA, volumeObject.getImageDim().getWidth(),
                    volumeObject.getImageDim().getHeight(), GL_ALPHA, GL_FLOAT, floatbuf );
                                    ...
                                    boolean trilinear )
    {
        ...
        gl.glGenTextures( 1, texId, 0 );
        gl.glBindTexture( GL_TEXTURE_3D, texId[ 0 ] );
        //gl.glTexImage3D( GL_TEXTURE_3D, 0, GL_ALPHA16F, width, height, depth, 0, GL_ALPHA, GL_SHORT, dataBuf );
...
//        gl.glGetTexLevelParameteriv( GL_TEXTURE_3D, 0, GL_TEXTURE_COMPRESSED, compressed, 0 );
//        System.out.println( "texture compressed? : " + compressed[ 0 ] );
//        
//        if (compressed[0] == 1)
//        {
//            int[] compressedSize = new int[ 1 ];
//            gl.glGetTexLevelParameteriv( GL_TEXTURE_3D, 0, GL_TEXTURE_COMPRESSED_IMAGE_SIZE, compressedSize, 0 );
...
//        }
    ...
    public static void texQuad3D(    GL2 gl,
                                            float sizeX,
                                            float sizeY,
                                            float tz )
    {
