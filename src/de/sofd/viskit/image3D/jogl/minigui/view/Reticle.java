...
public class Reticle extends Component
{
    ...
    public void showLineLeft( GL2 gl )
    {
        ...
        GLUtil.texQuad2D( gl, x, getPosY() - lineHeight / 2, lineWidth, lineHeight, -texWidth, texHeight, texWidth, -texHeight );
    }
    ...
    public void showLineRight( GL2 gl )
    {
        ...
        GLUtil.texQuad2D( gl, getPosX() + cross.getWidth() / 2 + 1, getPosY() - lineHeight / 2, lineWidth, lineHeight, 0, texHeight, texWidth, -texHeight );
    }
    ...
    public void showLineTop( GL2 gl )
    {
        ...
        GLUtil.texQuad2D( gl, getPosX() - lineWidth / 2, getPosY() + cross.getHeight() / 2, lineWidth, lineHeight, 0, 0, texWidth, -texHeight );
    }
}