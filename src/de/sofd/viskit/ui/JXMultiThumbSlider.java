...
public class JXMultiThumbSlider<E> extends JComponent {
    ...
    protected ThumbDataListener tdl;
    
    protected List<ThumbComp> thumbs;
    
    protected ThumbRenderer thumbRenderer;
    
    protected TrackRenderer trackRenderer;
    
    protected MultiThumbModel<E> model;

    protected List<ThumbListener> listeners = new ArrayList<ThumbListener>();
        
    protected ThumbComp selected;
    ...
    protected int getThumbIndex(ThumbComp thumb) {
    ...
    protected static class ThumbComp extends JComponent {
