...
public class Dcm2Dcm {
    ...
    private static CommandLine parse(String[] args) {
        ...
        opts.addOption(null, "no-fmi", false,
                "Encode result without File Meta Information. At default, " + " File Meta Information is included.");
        opts.addOption("e", "explicit", false,
                "Encode result with Explicit VR Little Endian Transfer Syntax. " + "At default, Implicit VR Little Endian is used.");
        opts.addOption("b", "big-endian", false,
                "Encode result with Explicit VR Big Endian Transfer Syntax. " + "At default, Implicit VR Little Endian is used.");
        opts.addOption("z", "deflated", false,
                "Encode result with Deflated Explicit VR Little Endian Syntax. " + "At default, Implicit VR Little Endian is used.");
    ...
    public static void main(String[] args) throws Exception {
        //I:\DICOM\dcm4che-2.0.18-bin\dcm4che-2.0.18\bin>dcm2dcm -t 1.2.840.10008.1.2.4.7 67010 67010.dcm
        //CommandLine cl = parse(args);
        String[] args2 = {"-t", "1.2.840.10008.1.2.4.70", "C:/Dokumente und Einstellungen/fokko/Eigene Dateien/data2/DICOM-1/6701/6702/67010", "C:/Dokumente und Einstellungen/fokko/Eigene Dateien/data2/DICOM-1/6701/6702/67010.dcm"};
        CommandLine cl = parse(args2);
        ...
        if (cl.hasOption("buffer")) {
            dcm2dcm.setTranscoderBufferSize(parseInt(cl.getOptionValue("buffer"),
    ...
    public void convert(File src, File dest) throws IOException {
        ...
        try {
            ...
            boolean recodeImages = !(bothRaw || sourceSyntax.equals(destinationSyntax));
            if (recodeImages) {
    ...
    private FileMetaInformation createFMI(File src) throws IOException {
        ...
        try {
            ...
            FileMetaInformation fmi = new FileMetaInformation(dis2.readDicomObject());
            fmi.init();
    ...
    private FileMetaInformation createFMI(DicomObject srcfmi) {
        ...
        return new FileMetaInformation(fmi.getMediaStorageSOPClassUID(), fmi.getMediaStorageSOPInstanceUID(), tsuid);
    }
}
