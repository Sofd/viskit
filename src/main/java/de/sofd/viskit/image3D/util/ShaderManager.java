...
import de.sofd.viskit.image3D.jogl.util.JGLARBShader;
...
public class ShaderManager
{
    ...
    public void bindARB( String shName )
    {
        getARB( shName ).bind();
    }
    ...
    public JGLARBShader getARB( String shName )
    {
        return (JGLARBShader)shMap.get( shName + ARB );
    }
    ...
    public void unbindARB( String shName )
    {
