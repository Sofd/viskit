 ...
 * @author olaf
 */
public class GLDrawingObjectViewerAdapter extends DrawingObjectViewerAdapter {

    public GLDrawingObjectViewerAdapter(DrawingViewer viewer, DrawingObject drawingObject) {
